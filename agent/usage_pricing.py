...
def resolve_billing_route(
    ...
    if provider_name in {"cursor", "cursor-headless", "cursor_headless"}:
        return BillingRoute(provider="cursor", model=model or "cursor", base_url=base_url or "", billing_mode="subscription_included")
